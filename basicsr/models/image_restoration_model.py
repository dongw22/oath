...
from basicsr.models.losses.losses import VGGPerceptualLoss
...
class ImageCleanModel(BaseModel):
    ...
    def init_training_settings(self):
        ...
        self.perceptual_loss = VGGPerceptualLoss().cuda()
    ...
    def optimize_parameters(self, current_iter):
        ...
        with autocast(enabled=self.use_amp):
            out_R1, out_R2, out_R3, out_L1, out_L2, out_L3  = self.net_g(self.lq)
            
            self.output = out_R1 * out_L1
            ...
            l_total, loss_dict = self.cri_pix(out1, out2, out3, self.gt)

            
            l1_R1 = F.smooth_l1_loss(out_R1, self.gt)
            percep_R1 = self.perceptual_loss(out_R1, self.gt) * 0.01
            
            
            l_total_R = (l1_R1 + percep_R1 ) * 0.5  #0.1
            l_total = l_total + l_total_R
        ...
        return l_total, loss_dict['cb_loss'], loss_dict['per_loss']
